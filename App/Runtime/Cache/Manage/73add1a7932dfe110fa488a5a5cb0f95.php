...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/newteng.php?s=/Category';
	    var APP	 = '/newteng.php?s=';
	    var SELF='/newteng.php?s=/Category/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
                                ...
                                <a href="<?php echo U(''.ucfirst($v['tablename']). '/index', array('pid' => $v['id']));?>" class="label label-info">列表</a>
