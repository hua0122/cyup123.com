...
<script src="/App/Manage/View/Public/js/frame.js?v201625" language="javascript" type="text/javascript"></script>
...
<div class="top_logo"> <img src="/App/Manage/View/Public/images/main/logo.png" /> </div>
	 ...
	 <div class="top_link">
      <ul>
        ...
        <li id="i_help"><a href="<?php echo go_link('http://www.Newteng.com/');?>" target="_blank">帮助</a></li>    
