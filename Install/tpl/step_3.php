	...
	<div class="xyh-main">
		...
		<table class="xyh-table-base xyh-table2">
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="text" value="newtengcms" name="DB_NAME" placeholder="<?php echo $lang['install_mysql_name_intro']; ?>" /></td>

			</tr>
			<tr>
				<td class="th"><?php echo $lang['install_mysql_prefix']; ?>：</td>
				<td colspan="2"><input type="text" class="text" value="newt_" name="DB_PREFIX" placeholder="<?php echo $lang['install_mysql_prefix_intro']; ?>" /></td>
			</tr>
			<tr class="tr-bg">
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="text" value="newteng" name="username" placeholder="<?php echo $lang['username']; ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="text" value="newteng@qq.com" name="email" placeholder="email" /></td>
			</tr>			
			<tr>
